...
$oldLastname = $_SESSION['register_old_lastname'] ?? '';
$oldFirstname = $_SESSION['register_old_firstname'] ?? '';
...
<head>
    ...
    <title>RegisztrĂˇciĂł - Astralus Intelligence</title>
  ...
  z-index: 2;
        ...
        *::-webkit-scrollbar-thumb {
        ...
        @keyframes introRingExpandClean {
            0% { opacity: 0; transform: scale(0.82); }
            40% { opacity: 0.20; }
            100% { opacity: 0.10; transform: scale(1.08); }
        }
        ...
        @keyframes introHorizonReveal {
            0% { opacity: 0; transform: translateY(-50%) scaleX(0.78); }
                        ...
                        <div class="hero-content">
                            <div class="hero-top">
                                ...
                                <h1 class="hero-title">
                                    Hozd lĂ©tre<br>
                                    a sajĂˇt<br>
                                    <span class="accent">fiĂłkod.</span>
                                </h1>

                                <p class="hero-text">
                                    NĂ©hĂˇny adat, Ă©s mĂˇris megnyĂ­lik a sajĂˇt Astralus munkafelĂĽleted.
                                </p>
                            ...
                            <div class="hero-bottom">
                                <div class="stat-card">
                                    <span class="stat-value">Astralus</span>
                                    <span class="stat-label">EgysĂ©ges brand Ă©s rendszer Ă©lmĂ©ny.</span>
                                </div>

                                <div class="stat-card">
                                    <span class="stat-value">Gyors</span>
                        ...
                        <div class="register-card">
                            <div class="register-card-inner">
                                <div class="register-top">
                                    <div class="panel-badge">Ăšj fiĂłk lĂ©trehozĂˇsa</div>
                                    <h2 class="register-title">RegisztrĂˇciĂł</h2>
                                    <p class="register-subtitle">
                                        TĂ¶ltsd ki az adataidat, Ă©s hozd lĂ©tre a sajĂˇt Astralus fiĂłkodat.
                                    </p>
                                </div>

                                <?php if (!empty($registerSuccess)): ?>
                                    <div class="form-message success"><?php echo htmlspecialchars($registerSuccess, ENT_QUOTES, 'UTF-8'); ?></div>
                                <?php endif; ?>
                                    ...
                                    <div class="field-grid two-col">
                                        <div class="field">
                                            ...
                                            <input
                                                ...
                                                name="lastname"
                                                class="input"
                                                placeholder="VezetĂ©knĂ©v"
                                                required
                                                value="<?php echo htmlspecialchars($oldLastname, ENT_QUOTES, 'UTF-8'); ?>"
                                            >
                                        </div>

                                        <div class="field">
                                            <label for="firstname" class="field-label">KeresztnĂ©v</label>
                                            <input
                                                type="text"
                                                id="firstname"
                                                name="firstname"
                                                class="input"
                                                placeholder="KeresztnĂ©v"
                                                required
                                                value="<?php echo htmlspecialchars($oldFirstname, ENT_QUOTES, 'UTF-8'); ?>"
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="password-wrap">
                                            <input
                                                ...
                                                name="password"
                                                class="input"
                                                placeholder="LegalĂˇbb 6 karakter"
                                                required
                                                autocomplete="new-password"
                                            >
                                            <button type="button" class="password-toggle" id="toggle-password">Mutat</button>
                                        </div>
                                    </div>

                                    <div class="field">
                                        <label for="password_confirm" class="field-label">JelszĂł megerĹ‘sĂ­tĂ©se</label>
                                        <div class="password-wrap">
                                            <input
                                                type="password"
                                                id="password_confirm"
                                                ...
                                                class="input"
                                                placeholder="ĂŤrd be Ăşjra a jelszĂłt"
                                                required
                                                autocomplete="new-password"
                                            >
                                            <button type="button" class="password-toggle" id="toggle-password-confirm">Mutat</button>
                                        </div>
                                    </div>

                                    <label class="terms-check">
                                        <input type="checkbox" name="terms" value="1" required>
                                        <span>Elfogadom a felhasznĂˇlĂˇsi feltĂ©teleket Ă©s az adatkezelĂ©si szabĂˇlyokat.</span>
                                    </label>

                                    <button type="submit" class="primary-btn">FiĂłk lĂ©trehozĂˇsa</button>
                                </form>
        ...
        (function () {
            function bindToggle(buttonId, inputId) {
                ...
                button.addEventListener('click', function () {
                    ...
                    button.textContent = isHidden ? 'Rejt' : 'Mutat';
                });
            }

            bindToggle('toggle-password', 'password');
            bindToggle('toggle-password-confirm', 'password_confirm');
        })();
